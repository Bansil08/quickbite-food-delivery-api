-- Quick-Bite — Performance Indexes
-- Covers: FK join columns, high-cardinality filter columns, and sort columns.
-- All InnoDB PKs are already B-Tree indexed; listed here are non-PK indexes only.
